        ...
        <div class="gal-col col-md-12">
            <div class="mySlides">
                <div class="numbertext">1 / 6</div>
                  <img src="images_properties/property_A/prop_01.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">2 / 6</div>
                  <img src="images_properties/property_A/prop_02.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">3 / 6</div>
                  <img src="images_properties/property_A/prop_03.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">4 / 6</div>
                  <img src="images_properties/property_A/prop_16.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">5 / 6</div>
                  <img src="images_properties/property_A/prop_17.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">6 / 6</div>
                  <img src="images_properties/property_A/prop_18.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
              ...
              <div class="img-row row">
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_A/prop_01.png" class="img-fluid" style="width:100%" onclick="currentSlide(1)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_A/prop_02.png" class="img-fluid" style="width:100%" onclick="currentSlide(2)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_A/prop_03.png" class="img-fluid" style="width:100%" onclick="currentSlide(3)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_A/prop_16.png" class="img-fluid" style="width:100%" onclick="currentSlide(4)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_A/prop_17.png" class="img-fluid" style="width:100%" onclick="currentSlide(5)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_A/prop_18.png" class="img-fluid" style="width:100%" onclick="currentSlide(6)" alt="">
                </div>
              </div>
        </div>
    </div>  
...
<div class="feat1-con container-fluid mt-5">
    <div class="feat1-row row">
        <div class="feat1-col col-md-12">
            <h4>3817 South Garden, Palisades Ayala Alabang, PH</h4>
        </div>
    </div>
</div>
...
<div class="map-con container-fluid mt-5 pt-5 mb-5 pb-5 ">
    <div class="map-row row">
      <div class="map-col col-md-12">
          <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1JKciAocRLREw_ixOnaUZ5StdQFcJgxc&ehbc=2E312F&noprof=1" width="950" height="720"></iframe>
      </div>
    </div>
</div>
