...
<!-- bidding 1 ######################  -->
      ...
      <div class="container">
        <div class="row">
            <div class="about-image col-md-6 gy-5">
                <img class="img-fluid" style="width: 750px;" height="400px" src="images_properties/property_F/prop_f_01.png" alt="">
              </div>  
          <div class="col-md-6 align-self-center gy-5">
            <h4>Bidding closes - Feb 29, 2024 | 9:00 PM </h4>
            <h4>Starting Bid - P28,400,000 - P30,000,000</h4>
            <h4 id="currentbids">Current Bid - P31,900,000</h4>
            <h4 id="reservebids">3 Bids - Reserve met</h4>
            <form class="row g-3 needs-validation" novalidate>
                <div class="col-md-9">
                    
                    <input type="number" class="form-control" placeholder="Amount" id="validationCustom02" value="" required>
                    <div class="invalid-feedback">
                        Please provide an amount.
                    </div>
                </div> 
            </form>
            <a href=""><button class="bid-btn btn btn-danger" type="submit">Place your Bid</button></a>
          </div>
        </div>
      </div>
  </div>
  ...
  <div class="address-con container mt-5 pt-5">
    <div class="address-row row">
        <div class="col-md-12">
            <h4>1522 Villefrenche</h4>
            <h4>Southpines Trece Martires, Cavite PH</h4>
