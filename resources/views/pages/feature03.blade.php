        ...
        <div class="gal-col col-md-12">
            <div class="mySlides">
                <div class="numbertext">1 / 6</div>
                  <img src="images_properties/property_C/prop_c_04.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">2 / 6</div>
                  <img src="images_properties/property_C/prop_c_03.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">3 / 6</div>
                  <img src="images_properties/property_C/prop_c_05.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">4 / 6</div>
                  <img src="images_properties/property_C/prop_c_07.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">5 / 6</div>
                  <img src="images_properties/property_C/prop_c_08.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
            
              <div class="mySlides">
                <div class="numbertext">6 / 6</div>
                  <img src="images_properties/property_C/prop_c_10.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>

              <div class="mySlides">
                <div class="numbertext">7 / 6</div>
                  <img src="images_properties/property_C/prop_c_11.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>

              <div class="mySlides">
                <div class="numbertext">8 / 6</div>
                  <img src="images_properties/property_C/prop_c_12.png" class="img-fluid" style="width: 700px;" height="500px">
              </div>
              ...
              <div class="img-row row">
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_C/prop_c_04.png" class="img-fluid" style="width:100%" onclick="currentSlide(1)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_C/prop_c_03.png" class="img-fluid" style="width:100%" onclick="currentSlide(2)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_C/prop_c_05.png" class="img-fluid" style="width:100%" onclick="currentSlide(3)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_C/prop_c_07.png" class="img-fluid" style="width:100%" onclick="currentSlide(4)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_C/prop_c_08.png" class="img-fluid" style="width:100%" onclick="currentSlide(5)" alt="">
                </div>
                <div class="column">
                  <img class="demo cursor" src="images_properties/property_C/prop_c_10.png" class="img-fluid" style="width:100%" onclick="currentSlide(6)" alt="">
                </div>
                {{-- <div class="column">
                    <img class="demo cursor" src="images_properties/property_C/prop_c_11.png" class="img-fluid" style="width:100%" onclick="currentSlide(7)" alt="">
                </div>
                <div class="column">
                    <img class="demo cursor" src="images_properties/property_C/prop_c_12.png" class="img-fluid" style="width:100%" onclick="currentSlide(8)" alt="">
                </div> --}}
...
<div class="feat1-con container-fluid mt-5">
    <div class="feat1-row row">
        <div class="feat1-col col-md-12">
            <h4>7869 Fareholm Drive, Tagaytay Nasugbu Hwy, Laurel Batangas, PH</h4>
        </div>
    </div>
</div>
...
<div class="map-con container mt-5 pt-5 mb-5 pb-5 ">
    <div class="map-row row">
      <div class="map-col col-md-12">
        ...
        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1oJLbzLIXx4_pYXAbTS9pKU2DqK-RqiM&ehbc=2E312F&noprof=1" width="950" height="720"></iframe>
